...
4th option: 1stと3rdを合わせた感じ．まずラグ変数を含めたモデルをスパースモデルで変数選択する．回帰係数EAPの絶対値上位50%を残して，そこから変数減少法で最良な組み合わせを見つけてそれを最終的なモデルとする．もしくは上位50%を残した時点でもう終了でも良い．

---
- とりあえず1st optionを進める．つまり，偏回帰係数の絶対値が大きい上位50%の説明変数を残す
- その残った説明変数で変数減少法 (stepwise)に従いながら評価基準の一番いい変数の組み合わせを見つける．__ここで，評価基準を決めなきゃいけない__
